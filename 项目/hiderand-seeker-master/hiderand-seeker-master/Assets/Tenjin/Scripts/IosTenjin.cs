...
public class IosTenjin : BaseTenjin
{
	...
	{
        TenjinCASIntegration.ListenForImpressions(CASILARHandler, casManager);
    }

	public override void SubscribeCASBannerImpressions(object casBannerView)
	{
        TenjinCASIntegration.ListenForBannerImpressions(CASILARHandler, casBannerView);
    }
	...
	public void CASILARHandler(string json)
	{
        if(!string.IsNullOrEmpty(json))
        {
