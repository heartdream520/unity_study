...
Shader "My/MoveLightImage"
{
 ...
 _Speed("Gloss",Range(1.0,256))=2

 _Liuguang_Color("Tex_Color",Color) = (1,1,1,1)
 }
 SubShader
 {
 ...
 uv.x+=-_Time.y*0.4*_Speed;
 //取灯光贴图的alpha值,黑色为0，白色为1 
 fixed4 lightTexA=tex2D(_LightTex,uv)*_Liuguang_Color;
