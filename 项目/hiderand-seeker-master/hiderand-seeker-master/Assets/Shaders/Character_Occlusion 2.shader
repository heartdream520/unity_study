...
Shader"MyShader/Transparent character occlusion and is 2D"
{
    Properties
    {
        //主纹理
 ...
 Pass
		{
            Tags { "Queue"="Transparent" "RenderType"="TransparentCutout" "LightMode" = "ForwardBase" "Rendering Mode" ="TransparentCutout" }
